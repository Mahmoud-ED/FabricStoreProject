...
Public Class CRReceiptFooter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FabricStoreProject.CRReceiptFooter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRReceiptFooter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRReceiptFooter = New CRReceiptFooter()
        rpt.Site = Me.Site
        Return rpt
    End Function
