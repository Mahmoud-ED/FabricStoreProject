...
Public Class CRItemsReports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FabricStoreProject.CRItemsReports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRItemsReports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRItemsReports = New CRItemsReports()
        rpt.Site = Me.Site
        Return rpt
    End Function
