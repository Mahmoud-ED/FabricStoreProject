...
Public Class CRWideFooter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FabricStoreProject.CRWideFooter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRWideFooter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRWideFooter = New CRWideFooter()
        rpt.Site = Me.Site
        Return rpt
    End Function
