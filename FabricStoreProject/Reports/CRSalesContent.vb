...
Public Class CRSalesContent
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FabricStoreProject.CRSalesContent.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRSalesContent
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRSalesContent = New CRSalesContent()
        rpt.Site = Me.Site
        Return rpt
    End Function
