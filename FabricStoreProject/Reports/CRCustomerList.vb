...
Public Class CRCustomerList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FabricStoreProject.CRCustomerList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRCustomerList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRCustomerList = New CRCustomerList()
        rpt.Site = Me.Site
        Return rpt
    End Function
