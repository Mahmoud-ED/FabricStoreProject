...
Public Class CRRecieptList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FabricStoreProject.CRRecieptList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRRecieptList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRRecieptList = New CRRecieptList()
        rpt.Site = Me.Site
        Return rpt
    End Function
