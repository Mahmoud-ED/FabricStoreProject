...
Public Class CRReceiptHeader2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FabricStoreProject.CRReceiptHeader2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRReceiptHeader2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRReceiptHeader2 = New CRReceiptHeader2()
        rpt.Site = Me.Site
        Return rpt
    End Function
