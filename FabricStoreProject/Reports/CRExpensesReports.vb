...
Public Class CRExpensesReports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FabricStoreProject.CRExpensesReports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRExpensesReports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRExpensesReports = New CRExpensesReports()
        rpt.Site = Me.Site
        Return rpt
    End Function
