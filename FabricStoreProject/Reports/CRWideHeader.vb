...
Public Class CRWideHeader
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FabricStoreProject.CRWideHeader.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRWideHeader
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRWideHeader = New CRWideHeader()
        rpt.Site = Me.Site
        Return rpt
    End Function
