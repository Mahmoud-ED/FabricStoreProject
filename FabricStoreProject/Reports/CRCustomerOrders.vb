...
Public Class CRCustomerOrders
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FabricStoreProject.CRCustomerOrders.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRCustomerOrders
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRCustomerOrders = New CRCustomerOrders()
        rpt.Site = Me.Site
        Return rpt
    End Function
