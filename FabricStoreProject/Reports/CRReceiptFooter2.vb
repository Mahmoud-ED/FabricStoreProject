...
Public Class CRReceiptFooter2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FabricStoreProject.CRReceiptFooter2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRReceiptFooter2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRReceiptFooter2 = New CRReceiptFooter2()
        rpt.Site = Me.Site
        Return rpt
    End Function
