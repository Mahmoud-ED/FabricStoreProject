...
Public Class CRCashingList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FabricStoreProject.CRCashingList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRCashingList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRCashingList = New CRCashingList()
        rpt.Site = Me.Site
        Return rpt
    End Function
