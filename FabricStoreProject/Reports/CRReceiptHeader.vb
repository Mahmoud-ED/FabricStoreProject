...
Public Class CRReceiptHeader
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FabricStoreProject.CRReceiptHeader.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRReceiptHeader
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRReceiptHeader = New CRReceiptHeader()
        rpt.Site = Me.Site
        Return rpt
    End Function
