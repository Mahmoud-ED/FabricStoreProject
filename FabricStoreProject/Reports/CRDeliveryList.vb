...
Public Class CRDeliveryList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FabricStoreProject.CRDeliveryList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRDeliveryList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRDeliveryList = New CRDeliveryList()
        rpt.Site = Me.Site
        Return rpt
    End Function
