Public Class FrmSuppleirReport
    ...
    Private Sub FrmSuppleirReport_VisibleChanged(sender As Object, e As EventArgs) Handles Me.VisibleChanged
    ...
    Private Sub ChkAll_CheckedChanged(sender As Object, e As EventArgs) Handles ChkAll.CheckedChanged
        ...
        If ChkAll.Checked = True Then
            ChkNameReport.Checked = False : TxtNameReport.Text = ""
    ...
    Private Sub BtnSearch_Click(sender As Object, e As EventArgs) Handles BtnSearch.Click
        If Not ChkAll.Checked And Not ChkNameReport.Checked And Not ChkAddress.Checked And Not ChkPhone.Checked Then
            Exit Sub
        End If
    ...
    Private Sub Search()
        ...
        SQLQuery = "   Select ROW_NUMBER() OVER (ORDER BY (ID)) As ت, * From SuppliersTable where  EndService IS NULL  "

        AppendConditions()

        SQLQuery &= " ORDER BY ID  OFFSET " & PageSize * (PageNum - 1) & " ROWS FETCH NEXT " & PageSize & " ROWS ONLY"

        SQLQuery &= " Select COUNT(SuppliersTable.ID)  From  SuppliersTable where  EndService IS NULL "
        AppendConditions()
    ...
    Private Sub FillDGV()
        ...
        For i = 0 To DSLoadSearch.Tables(0).Rows.Count - 1
            ...
            With DSLoadSearch.Tables(0).Rows(i)
                ...
                DGVReport.Item(2, i).Value = .Item("Name")
                DGVReport.Item(4, i).Value = .Item("Address")

                If Not .Item("Phone1") = "" Then
                    DGVReport.Item(3, i).Value = .Item("Phone1")
                End If

                If Not .Item("Phone2") = "" Then
                    If DGVReport.Item(3, i).Value = "" Then
                        DGVReport.Item(3, i).Value = .Item("Phone2")
                    Else
                        DGVReport.Item(3, i).Value = DGVReport.Item(3, i).Value & " - " & .Item("Phone2")
                    End If
    ...
    Private Sub AppendConditions()
        ...
        If ChkNameReport.Checked And TxtNameReport.Text <> "" Then
            AppendToQuery(" AND ", " Name   Like  '%" & TxtNameReport.Text & "%'")

        End If

        If ChkPhone.Checked And TxtPhoneReport.Text.Trim <> "" Then
            AppendToQuery(" And ", " Phone1   Like  '%" & Val(TxtPhoneReport.Text) & "%'")
    ...
    '------------------------------------CheckBox-----------------------------------------------------
    Private Sub ChkEmpName_CheckedChanged(sender As Object, e As EventArgs) Handles ChkNameReport.CheckedChanged

        DGVReport.Rows.Clear()
        If ChkNameReport.Checked = True Then
    ...
    Private Sub AppendReportConditions()
        ...
        If ChkNameReport.Checked And TxtNameReport.Text.Trim <> "" Then AppendToQuery(" AND ", " Name Like @Name")
        If ChkAddress.Checked And TxtAddress.Text.Trim <> "" Then AppendToQuery(" AND ", " Address=@Address")
        If ChkPhone.Checked And TxtPhoneReport.Text.Trim <> "" Then AppendToQuery(" AND ", " PhoneNum1 Like @PhoneNum")
    ...
    Private Sub BtnRefreshPage_Click(sender As Object, e As EventArgs) Handles BtnRefreshPage.Click
        If Not ChkAll.Checked And Not ChkNameReport.Checked And Not ChkAddress.Checked And Not ChkPhone.Checked Then Exit Sub
    ...
    Private Sub BtnPrintAll_Click(sender As Object, e As EventArgs) Handles BtnPrintAll.Click
        ...
        'SQLQuery = "SELECT FORMAT(Num,'0000') AS Num,Name,PhoneNum1,PhoneNum2,FORMAT(StartDate,'" & GetDateAndTimeFormat(DTFormat.DF) & "') AS StartDate FROM EmployeeTable WHERE EndService IS NULL"
        ...
        '    New SqlParameter("@PhoneNum", "%" & TxtPhoneReport.Text & "%")}
    ...
    Private Sub DGVReport_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DGVReport.CellContentClick
        If CheckDGVError(DGVReport) = True Then Exit Sub
    End Sub
    ...
    Private Sub DGVReport_DoubleClick(sender As Object, e As EventArgs) Handles DGVReport.DoubleClick
        ...
        Dim CR As Integer
        CR = DGVReport.CurrentRow.Index
        SuppleirReportID = DGVReport.Item(0, CR).Value
        FrmSuppleirContainer.LblInfo_Click(sender, e)
    End Sub
